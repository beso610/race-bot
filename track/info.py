...
bRP = {'brp', 'rp', 'GBA リバーサイドパーク', 'GBAリバーサイドパーク', 'リバーサイドパーク', 'リバーサイド', 'リバー', 'リバサ', 'リバパ', 'りばさ', 'りばーさいど', 'りばーさいどぱーく', 'りばー'}
bDKS = {'bdks', 'dks', 'Wii DKスノーボードクロス', 'WiiDKスノーボードクロス', 'DKスノーボードクロス', 'スノーボードクロス', 'スノボ', 'すのぼ'}
bYI = {'byi', 'yi', 'ヨッシーアイランド', 'ヨシア', 'よしあ', 'よっしーあいらんど', 'よしじま', 'ヨシじま'}
...
bSSy = {'bssy', 'ssy', 'Tour シンガポールスプラッシュ', 'Tourシンガポールスプラッシュ', 'シンガポールスプラッシュ', 'シンガポール', 'シンスプ', 'しんがぽーる', 'しんすぷ', 'シンガ', 'しんが'}
...
TRACKS = [['マリカス', MKS], ['ウォタパ', WP], ['スイキャニ', SSC], ['ドッスン', TR], \
    ...
    ['アムステルダム', bAD], ['リバーサイド', bRP], ['スノボ', bDKS], ['ヨシ島', bYI], \
    ['バンコク', bBR], ['DSマリサ', bMC], ['ワルスタ', bWS], ['シンガポール', bSSy]]
